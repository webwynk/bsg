...
const MOCK_AGENTS = [
  { id: '1', name: 'Alpha Agency', username: 'agent_alpha', balance: 5000000, status: 'Active' },
  { id: '2', name: 'Beta Gaming', username: 'agent_beta', balance: 1200000, status: 'Active' },
  { id: '3', name: 'Omega Slots', username: 'agent_omega', balance: 0, status: 'Blocked' },
  { id: '4', name: 'Delta Group', username: 'agent_delta', balance: 850000, status: 'Active' },
  { id: '5', name: 'Zeta Payouts', username: 'agent_zeta', balance: 2500000, status: 'Active' },
]
...
export default function AgentsPage() {
  ...
  const paginatedAgents = MOCK_AGENTS.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage)
